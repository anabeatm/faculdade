...
litros_necessarios = area_pintar / 3 # A quantidade de litros necessários para cobrir toda a área a ser pintada 
...
precoTotal = latas_necessarias * 120 # Por último calculamos o valor total mutiplicando a quantidade de latas total pelo preço de cada lata.
